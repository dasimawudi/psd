    ...
    def __init__(
        ...
        if self.use_two_stage_rmises:
            ...
            self.rmises_decoder = build_mlp(
                input_dim=stress_context_dim + 1,
                hidden_dim=hidden_dim,
                output_dim=1,
                num_layers=3,
                dropout=dropout,
            ...
            self.hotspot_context_modulation = (
                FeatureModulation(
                    feature_dim=stress_context_dim,
                    conditioning_dim=conditioning_dim,
                )
                if enable_conditioning and conditioning_dim is not None
                else None
            ...
            self.rmises_context_modulation = (
                FeatureModulation(
                    feature_dim=stress_context_dim + 1,
                    conditioning_dim=conditioning_dim,
                )
                if enable_conditioning and conditioning_dim is not None
                else None
            ...
            self.rmises_context_modulation = (
                FeatureModulation(feature_dim=stress_context_dim, conditioning_dim=conditioning_dim)
                if enable_conditioning and conditioning_dim is not None
                else None
            )
