...
def main() -> None:
    ...
    logger = make_logger(output_dir, logger_name="case7_node_mlp.evaluate", log_file="evaluate.log")
    ...
    if not args.no_curve_diagnostics and curve_cases > 0:
        from case7_node_mlp.sample_frequency_curves import run_frequency_curve_diagnostics
