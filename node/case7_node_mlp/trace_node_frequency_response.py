...
def _load_model(checkpoint: dict[str, Any], config: dict[str, Any], device: torch.device) -> tuple[PointMLP, StandardScaler, StandardScaler, dict[str, Any]]:
...
def main() -> None:
    ...
    logger = make_logger(output_dir, logger_name="case7_node_mlp.trace_node_frequency_response", log_file="trace_node_frequency_response.log")
